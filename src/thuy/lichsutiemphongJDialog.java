 ...
 * @author Hieu
 */
public class lichsutiemphongJDialog extends javax.swing.JDialog {
     ...
     */
    public lichsutiemphongJDialog(java.awt.Frame parent, boolean modal) throws Exception {
        super(parent, modal);
        initComponents();
...
//
    ...
    private void btn_ThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ThemActionPerformed
        try {
            ...
            Logger.getLogger(lichsutiemphongJDialog.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lichsutiemphongJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lichsutiemphongJDialog dialog = null;
                try {
                    dialog = new lichsutiemphongJDialog(new javax.swing.JFrame(), true);
                } catch (Exception ex) {
                    Logger.getLogger(lichsutiemphongJDialog.class.getName()).log(Level.SEVERE, null, ex);
                }
