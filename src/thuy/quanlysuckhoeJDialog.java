 ...
 * @author Hieu
 */
public class quanlysuckhoeJDialog extends javax.swing.JDialog {
    int row = -1;
     ...
     */
    public quanlysuckhoeJDialog(java.awt.Frame parent, boolean modal) throws Exception {
        super(parent, modal);
        initComponents();
...
//
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(quanlysuckhoeJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                quanlysuckhoeJDialog dialog = null;
                try {
                    dialog = new quanlysuckhoeJDialog(new javax.swing.JFrame(), true);
                } catch (Exception ex) {
                    Logger.getLogger(quanlysuckhoeJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                }
